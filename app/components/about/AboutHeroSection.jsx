  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/expertises/meta_ads.png"
          alt=""
          fill
          sizes="100vw"
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 w-full py-8 md:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            {/* Description */}
            <p
              className="text-[14px] md:text-[15px] leading-relaxed text-[#A0A0A0] mb-6 md:mb-8 max-w-[560px] transition-all ease-[cubic-bezier(0.16,1,0.3,1)]"
              style={{
          ...
          <div
            ...
            style={{
              ...
              opacity: mounted ? 1 : 0,
              transform: mounted ? "scale(1) translateY(0)" : "scale(0.94) translateY(30px)",
            }}
          >
            {/* Photo principale */}
      ...
      >
        {/* Texte SCROLL — visible + doré + glow */}
