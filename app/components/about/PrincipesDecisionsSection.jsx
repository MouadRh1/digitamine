...
// ═══════════════════════════════════════════
// RevealAccordion : chaque item de l'accordéon
// ═══════════════════════════════════════════
function RevealAccordion({ children, delay = 0, duration = 900 }) {
  const [ref, isInView] = useInView();
...
export default function PrincipesDecisionsSection() {
  ...
  return (
    <section className="relative bg-[#050505] py-20 md:py-28 lg:py-32 overflow-clip">
      {/* Halo doré diffus */}
      <div
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <div className="mb-12 md:mb-16">
          ...
          >
            <RevealMask delay={150} duration={1100}>
              <span className="block">Ce qui guide nos décisions,</span>
            </RevealMask>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6 lg:sticky lg:top-24">
            <RevealImage delay={400} duration={1400}>
              {/* 
                ✅ Ratio corrigé : image moins haute
                - Mobile  : aspect-[5/6]  (portrait léger)
                - Desktop : aspect-square (carré)
              */}
              <div className="relative w-full aspect-[5/6] lg:aspect-square overflow-hidden border border-[rgba(201,162,39,0.2)]">
                <Image
              ...
              {principes.map((p, i) => {
                ...
                return (
                  <RevealAccordion
                    ...
                    duration={900}
                  >
                    <div className="border-b border-[rgba(201,162,39,0.2)]">
                      {/* Header cliquable */}
                      <button
