  ...
  return (
    <section className="relative bg-[#EDEAE3] min-h-[70vh] max-h-[90vh] flex items-center py-16 md:py-20 lg:py-24">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 w-full">
        {/* Label supérieur */}
        <p className="font-display text-[11px] md:text-[12px] tracking-[0.22em] uppercase text-[#C9A227] mb-6 md:mb-8">
          Le point de départ
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-20 max-w-[1200px] ml-auto">
          <p className="text-[14px] md:text-[15px] leading-relaxed text-[#1a1a1a]">
            Publier, créer un site ou lancer une campagne ne suffit
            pas lorsque chaque action avance dans une direction
            différente.
          </p>

          <p className="text-[14px] md:text-[15px] leading-relaxed text-[#1a1a1a]">
            Nous commençons par comprendre votre entreprise.
            Ensuite, nous connectons les bons leviers dans un
            système clair.
          </p>
        </div>
      </div>
